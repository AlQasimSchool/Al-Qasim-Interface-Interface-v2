export const DEFAULT_LINKS = [
    { name: 'الموقع التعريفي الرسمي (Branding)', desc: 'نبذة شاملة عن رؤيتنا، مسيرتنا، وإنجازاتنا في إعداد قادة يخدمون دينهم ووطنهم.', icon: 'fas fa-shield-halved', color: 'green', url: 'http://alqasimbusiness.wuaze.com/', cat: 'sites' },
    { name: 'موقع كشافة عبدالرحمن بن القاسم (الأساسي)', desc: 'المنصة الأساسية لمتابعة الأنشطة والتسجيل والأخبار الدورية.', icon: 'fas fa-campground', color: 'brown', url: 'https://scout-abdulrahman-bin-al-qasim.lovable.app/', cat: 'sites' },
